...
| `feature_values` | 93 |
| `glossary` | 84 |
| `implementation_claims` | 451 |
| `implementations` | 64 |
| `learning_coverage_expectations` | 11 |
| `learning_edges` | 46 |
| `learning_slice_priorities` | 6 |
| `method_hierarchy` | 88 |
| `method_implementation_map` | 162 |
| `method_visualization_profiles` | 8 |
| `methods` | 105 |
| `model_revisions` | 7 |
...
| `problem_definition_archetypes` | 16 |
| `problem_definition_features` | 38 |
| `problem_definitions` | 11 |
| `problem_feature_map` | 842 |
| `problem_features` | 211 |
| `problem_instances` | 12 |
...
| `sheet_catalog` | 33 |
| `sources` | 101 |
| `terminology_aliases` | 37 |
| `version_history` | 3 |
| `view_presets` | 6 |

## Free-text-only method conditions

Detected `396` populated condition fields across `99` methods without complete atomic-predicate coverage.
