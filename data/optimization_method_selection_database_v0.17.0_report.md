...
| `problem_definition_archetypes` | 15 |
| `problem_definition_features` | 30 |
| `problem_definitions` | 10 |
| `problem_feature_map` | 842 |
| `problem_features` | 211 |
| `problem_instances` | 11 |
...
| `sheet_catalog` | 33 |
| `sources` | 96 |
| `terminology_aliases` | 34 |
| `version_history` | 3 |
| `view_presets` | 6 |

## Free-text-only method conditions

Detected `372` populated condition fields across `93` methods without complete atomic-predicate coverage.
