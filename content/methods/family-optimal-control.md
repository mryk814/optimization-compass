...
[pendulum swing-up Case](#/gallery/EC029)では、dynamicsと初期・終端・path制約を固定します。予算とtoleranceも揃え、N=20とN=40のmeshを比較できます。primary Theaterはnode上のdefectと区間再構成のviolationを分けます。failure Theaterではgravityを変えたvalidation rolloutでmodel mismatchを確認します。
