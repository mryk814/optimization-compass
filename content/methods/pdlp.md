...
- iteration数を増やしてもresidualが縮まらない
- infeasibleまたはunboundedの兆候が出ているのに残差だけを見て見落とす
- coefficient scaleが極端でstep sizeの見積もりが保守的すぎる／不足する
- 高精度なbasisやsensitivityが必要になり中精度解では不足する
- restartを繰り返しても収束が遅い
