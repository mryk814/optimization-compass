...
[pendulum swing-up Case](#/gallery/EC027)ではnode feasibilityと区間再構成を分けます。[mesh sensitivity Compare](#/compare/COMPARE_PENDULUM_COLLOCATION_MESH)ではN=20とN=40をcontrast-onlyで確認できます。観測ごとに再solveする用途では[receding horizon](#/learn/concept.receding-horizon)へ進みます。
