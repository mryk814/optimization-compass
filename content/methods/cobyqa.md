...
この手法の気持ちは、**gradientを直接聞けないなら、近くで試した複数点から目的関数と制約の曲がり方を推測し、そのmodelを信用できる範囲だけで次の点を選びたい**というものです。
...
正確なgradientとJacobianを用意できるならSLSQPやinterior-pointも比較します。一評価が極端に高価ならsurrogate-based global searchとのbudget比較が必要です。
