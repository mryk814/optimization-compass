...
現在の公開データセットは **v0.5.1** です（2026-07-15 release）。
...
ベイズ最適化については、代理モデル・不確実性・獲得関数・探索と活用を説明する日本語ガイドも公開しています。
...
canonical problem / scenario / comparisonと生成artifactのidentityはv0.5.1で整合済みです。Coverageは、残る教材・可視化・比較・predicate移行の不足を次の拡張対象として表示します。
