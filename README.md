...
| Published content pages | 69 |
| Public Gallery cases | 11 |
| Public comparisons | 4 |
| Visualization scenarios | 18 |

このブロックはrelease authority、生成report、公開site dataから生成します。手作業で件数を変更しません。
