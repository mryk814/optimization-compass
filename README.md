...
現在の公開データセットは **v0.4.0** です（2026-07-15 release）。
...
canonical scenario / comparisonと生成artifactのidentityはv0.4.0で整合済みです。Coverageは、残る教材・可視化・比較・predicate移行の不足を次の拡張対象として表示します。
