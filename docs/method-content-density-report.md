...
| `adjoint-sensitivity` | `M_ADJOINT_SENSITIVITY` | 69 | 1324 | 6 | 0 | fail |
...
| `cobyla` | `M_COBYLA` | 66 | 2888 | 9 | 1 | pass |
| `cobyqa` | `M_COBYQA` | 65 | 2473 | 7 | 1 | pass |
| `constrained-continuous` | `MF_CONSTRAINED_NLP` | 93 | 4321 | 11 | 1 | pass |
...
| `density-filter` | `M_DENSITY_FILTER` | 76 | 985 | 5 | 0 | fail |
...
| `least-squares` | `M_LEVENBERG_MARQUARDT` | 79 | 3560 | 13 | 1 | pass |
| `local-search-combinatorial` | `M_LOCAL_SEARCH_COMBINATORIAL` | 57 | 3176 | 8 | 1 | pass |
| `lp-qp-conic` | `MF_LP_QP_CONIC` | 83 | 3114 | 13 | 1 | pass |
...
| `optimality-criteria-topology` | `M_OC_TOPOLOGY` | 87 | 992 | 6 | 0 | fail |
...
| `pbt` | `M_PBT` | 110 | 4139 | 9 | 1 | pass |
| `pdlp` | `M_PDLP` | 55 | 3650 | 9 | 1 | pass |
| `powell` | `M_POWELL` | 61 | 2132 | 7 | 1 | pass |
| `primal-dual-conic` | `M_PRIMAL_DUAL_CONIC` | 73 | 3277 | 9 | 1 | pass |
| `primal-simplex` | `M_SIMPLEX` | 61 | 3180 | 8 | 1 | pass |
| `projected-gradient` | `M_PROJECTED_GRADIENT` | 58 | 2491 | 8 | 1 | pass |
| `proximal-gradient` | `M_PROX_GRADIENT` | 55 | 2434 | 7 | 1 | pass |
| `random-search` | `M_RANDOM_SEARCH` | 89 | 3113 | 8 | 1 | pass |
| `riemannian-gradient` | `M_RIEMANNIAN_GRADIENT` | 68 | 2876 | 9 | 1 | pass |
