...
Issue: #136
Dataset boundary: cumulative 0.18.7 staging; ordinary content publication must not publish it alone.
...
| rotation averaging and distances | SO(3) flagship | S107, Hartley et al. | same manifold toolkits | staged in 0.18.7 |
...
| --- | --- | --- | --- |
| SO(3) flagship | Case, Theater, Compare, problem instance, exact context staged | integrate common comparison validator and cumulative 0.18.7 release | context, problem, profile, and generated artifact must resolve together |
